...
public class AuthService {
    ...
    public CompanyDtos.CompanyRegistrationResponse registerCompany(CompanyDtos.CompanyRegistrationRequest request) {
        ...
        return new CompanyDtos.CompanyRegistrationResponse(
                ...
                new UserDtos.UserResponse(
                        ...
                        owner.getCreatedAt()),
                new AuthDtos.AuthResponse(accessToken, 86400000L, refreshTokenStr) // Hardcoded exp for now
        );
    }
    ...
    private String generateRefreshToken(User user) {
        ...
        RefreshToken rt = RefreshToken.builder()
                .user(user)
                .tokenHash(token) // Storing plain text UUID for now as "hash" effectively, or real hash.
